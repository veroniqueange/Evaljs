...
function afficher5Article(){
    ...
    var article = new Article("article1", "ceci est une description");
    listeArticles.push(article);

    var article = new Article("article 2", "ceci est une description");
    listeArticles.push(article);

    var article = new Article("article 3", "ceci est une description");
    listeArticles.push(article);

    var article = new Article("article 4", "ceci est une description");
    listeArticles.push(article);

    var article = new Article("article 5", "ceci est une description");
    listeArticles.push(article);
    console.log(onclick);
...
function toutAfficher(){
    ...
    var divHtmlTitreArticle = "Mes articles";
